...
// binary-trees C gcc #2 program
// https://benchmarksgame-team.pages.debian.net/benchmarksgame/program/binarytrees-gcc-2.html
...
Java_com_example_urutauappfinal_algorithms_c_CAlgorithms_cBinaryTreesRun(JNIEnv *env, jclass thiz, jint num) {
    ...
    const intnative_t minimum_Tree_Depth=4,
            maximum_Tree_Depth=num<minimum_Tree_Depth+2 ?
                               minimum_Tree_Depth+2 : num;
